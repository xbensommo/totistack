<template>
  <section class="page-wrap space-y-8">
    <header class="hero-panel space-y-4">
      ...
      <div><h1 class="page-title">Lead Detail</h1><p class="page-subtitle">Review one lead, related activity, and conversion actions.</p></div>
    </header>
...
<script setup>
/**
 * @file crm/pages/LeadDetailPage.vue
